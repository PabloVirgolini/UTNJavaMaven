	...
	<div class="container">
		...
		<div class="table-responsive">
			<table class="table table-striped">
				...
				<tbody>
					<%
					LinkedList<Cargo> lm = cDAO.getAll();
					for (Cargo m: lm) {
					%>
					<tr>
						<td class="id"><%= m.getIdCargo()%></td>
		  ...
		  <div class="modal-dialog modal-lg">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h1 class="modal-title fs-5" id="exampleModalLabel">Datos Cargo</h1>
		        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		      </div>
		      <div class="modal-body">
		      
		        <form action="${pageContext.servletContext.contextPath}/CargoServlet" method="post" role="form">
		        	<div class="row">
		        		<div class="col-6">
		        			<label>Codigo</label>
...
<!-- 	Agrego librerias de JS de DataTables (CDNs) -->
    ...
    <script src="${pageContext.servletContext.contextPath}/js/cargo.js"></script>
